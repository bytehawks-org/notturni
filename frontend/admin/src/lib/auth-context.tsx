...
// Chiave distinta da "notturni_auth" del frontend pubblico: pagine servite
// da origin/porta diverse, ma comunque nessuna sovrapposizione possibile
// (localStorage è già isolato per origin dal browser).
const STORAGE_KEY = "notturni_admin_auth";
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const value = useMemo(
    () => ({ user, accessToken, loading, login, verifyMfa, logout, authFetch }),
    [user, accessToken, loading, login, verifyMfa, logout, authFetch]
  );
